---
ms.openlocfilehash: 228983ab9d9577591092a95c77b7531a6b97d0ef
ms.sourcegitcommit: bab1265d669c3e6871daa7cb8a5640a47104947a
translationtype: MT
---
<properties pageTitle="Git 命令转移的新的或更新的文章" description="用于预览新的和更新的文章的步骤。" metaKeywords="" services="" solutions="" documentationCenter="" authors="tysonn" videoId="" scriptId="" manager="carolz" />

<tags ms.service="contributor-guide" ms.devlang="" ms.topic="article" ms.tgt_pltfrm="" ms.workload="" ms.date="01/16/2015" ms.author="tysonn" />

# 临时预览内部网站上的一篇文章的 Git 命令

转移是现在自动化专用存储库拉请求。 请参阅[创建新文章或更新现有项目的 Git 命令](git-commands-for-master.md)
