---
ms.openlocfilehash: 0d0fa670d39007502e5b6436f3ec225c57f4af52
...
本文提供了 Azure IaaS Windows 虚拟机配置 Azure VM 扩展的示例配置。
...
文章的其余部分提供了有关 Windows VM 扩展配置示例。
...
### 对于 Microsoft Azure barracuda VPN 连接代理
          {
