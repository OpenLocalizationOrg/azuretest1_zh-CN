---
ms.openlocfilehash: c3d610783976c33bfd93bdbbc580e7009086afa3
ms.sourcegitcommit: bab1265d669c3e6871daa7cb8a5640a47104947a
translationtype: MT
---
<properties
    pageTitle="入门的 azure AD AngularJS |Microsoft Azure"
    description="如何构建有两个人的 Microsoft 帐户的用户和工作或学校的帐户登录角度 JS 单页应用程序。"
...
# 应用程序模型 v2.0 预览︰ 登录添加到 AngularJS 的单页应用程序

AngularJS 应用程序的快速启动指南尚未完全准备好...稍后再试，并查找从 @AzureAD 上 Twitter 更新。
