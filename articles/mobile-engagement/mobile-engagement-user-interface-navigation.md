---
ms.openlocfilehash: 0038f8363336c9c29fc40cd33195623cc9a45c5a
ms.sourcegitcommit: bab1265d669c3e6871daa7cb8a5640a47104947a
translationtype: MT
---
<properties 
   pageTitle="Azure 的移动服务用户界面的导航" 
   description="了解如何导航 Azure 移动服务门户的用户界面" 
...
# 如何在用户界面中导航
在 UI 前端门户网站︰ https://YourApp.portal.mobileengagementwindows.net/ 包含以下的导航元素︰ 标题、 页脚、 特写、 cookie 面包屑导航，以及特定于应用程序的功能区。
 
![Navigation1][1] 

## 页眉
- **Azure 移动服务 （徽标）** – Azure 移动服务应用程序的主页
- **您的名字**– 我帐户的配置文件
- **文档**– [Azure 的移动服务文档][链接 10]
- **退出**--从 Azure 的移动服务号
 
## 页脚
- **服务条款**[http://azure.microsoft.com/support/legal/](http://azure.microsoft.com/support/legal/)
- **隐私和 Cookie**[http://www.microsoft.com/privacystatement/OnlineServices/Default.aspx](http://www.microsoft.com/privacystatement/OnlineServices/Default.aspx)
...
<!--Link references-->
[链接 1]: ../mobile-engagement-user-interface/
[链接 2]: ../mobile-engagement-troubleshooting-guide/
[链接 3]: ../mobile-engagement-how-tos/
